...
if __name__ == "__main__":
    try:
        ...
        # Initialiser le module doc_analyzer
        if not setup_doc_analyzer():
            logger.error("Erreur lors de l'initialisation du module doc_analyzer")
            sys.exit(1)
        ...
        # Initialiser le gestionnaire de configuration et le modèle
        config = ConfigManager()
        app_model = AppModel(config)
